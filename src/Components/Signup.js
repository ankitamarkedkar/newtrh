          ...
          <Grid container spacing={12}>
            <Grid item xs={12} md={6}>
              <h2>
                SIGN UP
                <br />
                <span className="free">Create New Account is Free</span>
              </h2>
            ...
            <Grid item xs={12} md={6}>
              ...
              <FormControl variant="standard">
                ...
                <TextField id="" label="Email" variant="filled" />
                <br />
                <label>Contact No. </label>
                <TextField id="" label="Contact" variant="filled" />
                <br />
                <label>DOB </label>
                <TextField id="" label="DOB" variant="filled" />
                <br />
                <label>Role </label>
                <TextField id="" label="Role" variant="filled" />
                <br />
                <FormGroup>
                  <FormControlLabel
                    control={<Checkbox />}
              ...
              <Button variant="outlined" className="googlebutton">
                <i class="fa fa-google"></i>Continue As Google
              </Button>
            </Grid>
          </Grid>
        </Container>
