                    ...
                    <Grid container spacing={2}>
                        ...
                        <Modal open={openmodal} onClose={handleClosemodal} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
                            <Box className="modalannounce">
                                ...
                                <br />
                                <TextField id="" label="Announcement Title" variant="outlined" />
                                <br />
                                <Typography className="calendermui">
                                    <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                        <KeyboardDatePicker value={selectedDate1} onChange={handleDateChange1} />
                                    </MuiPickersUtilsProvider>
                                </Typography>
                                <br />
                        ...
                        <Grid item xs={12} md={6}>
                            <Paper elevation={3} className="candash">
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} md={4}>
                                        <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                            <KeyboardDatePicker value={selectedDate2} onChange={handleDateChange2} />
                                        </MuiPickersUtilsProvider>
                                    </Grid>
                                </Grid>
                                <div>
                                ...
                                <Typography className="schedule">
                                    <Button onClick={handleOpenschedule} className="announcebutton">
                                    Create a New Schedule                                    
                                    </Button>
                                </Typography>
                                <Modal open={openschedule} onClose={handleCloseschedule} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
                            <Box className="modalannounce">
                                <Typography id="modal-modal-title" variant="h6" component="h2">
                                    Schedule
                                </Typography>
                                ...
                                <Typography className="calendermui">
                                    <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                        <KeyboardDatePicker value={selectedDate3} onChange={handleDateChange3} />
                                    </MuiPickersUtilsProvider>
                                </Typography>
                                <br />
                                <Buttonresuable label="Submit" />
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <FormControl variant="standard" className="commentform">
                                ...
                                <br />
                                <TextareaAutosize placeholder="Give Feedback Here" className="textcom" />
                                <br />
                                <br />
