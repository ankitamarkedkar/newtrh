      ...
      <Container>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={3}>
            ...
            <ul>
              <li>
                <Link href="Hrdashboard" underline="none">
                  {"HR Dashboard"}
                </Link>
              </li>
              <li>
                <Link href="Interviewdashboard" underline="none">
                  {"Interviewer Dashboard"}
                </Link>
              </li>
              <li>
                <Link href="Candidatedashboard" underline="none">
                  {"Candidate Dashboard"}
                </Link>
              </li>
            </ul>
          ...
          <Grid item xs={12} md={3}>
            ...
            <p>
              ...
              <span>
                <Link href="mailto:sales@therapidhire.com">
            ...
            <p>
              ...
              <span>
                <Link href="telto:0731 356 20055">0731 356 20055</Link>
              </span>
            </p>
          </Grid>
        </Grid>
