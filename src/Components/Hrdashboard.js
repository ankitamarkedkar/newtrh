...
const column = [
  {
      title: "Avatar",
      field: "imageUrl",
      render: (row) => <img src={row.imageUrl} style={{ width: 40, borderRadius: "50%" }} alt=""/>,
  },
...
console.log(column)
const rows = [
  createData('https://v4.mui.com/static/images/avatar/1.jpg','Brad Simmons', 'https://www.youtube.com/watch?v=ysz5S6PUM-U', 'fa fa-check', 'fa fa-close', 'fa fa-star'),
  createData('https://mui.com/static/images/avatar/2.jpg','Jessie Clarcson', 'https://assets.coderrocketfuel.com/pomodoro-times-up.mp3', 'fa fa-check', 'fa fa-close', 'fa fa-star'),
  createData('https://mui.com/static/images/avatar/3.jpg','Natali Trump', 'https://assets.coderrocketfuel.com/pomodoro-times-up.mp3', 'fa fa-check', 'fa fa-close', 'fa fa-star'),
];
...
export default function Hrdashboard() {
    ...
    return (
            ...
            <Box className="headcandid">
                <Container>
                    <Grid container spacing={3}>
                        <Grid item xs={6} lg={4}>
                        <Link href="/"><img src="images/logo.png" alt="imagetrh" /></Link> 
                        </Grid>
        ...
        <Tooltip title="Account settings" className="dashaccount">
          ...
          >
            <Avatar alt="Remy Sharp" src="https://v4.mui.com/static/images/avatar/1.jpg" /><i className="fa fa-angle-down"></i>
          </IconButton>
        </Tooltip>
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={6} lg={4}>
                            <h2>
                                Shortlist Candidate
                                <br />
                                <span className="free"><Link href ="/Signup" underline="none">Create New Account </Link></span>
                            </h2>
                        </Grid>
                        <Grid item xs={6} lg={8}>
                            <Button variant="contained" color="primary" className="dash">
      ...
      <Table sx={{ minWidth: 650 }} aria-label="caption table" >
        ...
        <TableBody>
          ...
          url={row.recorded}   width="100%" 
          height="50px"
          playing
          playIcon={<i className="fa fa-play"/>}
          light="https://i.stack.imgur.com/zw9Iz.png" target='_blank'
          
        /> 
        
        </TableCell>
              <TableCell align="center"><i className={row.selected} /></TableCell>
              <TableCell align="center"><i className={row.rejected} /></TableCell>
              <TableCell align="center"><i className={row.review} /><i className={row.review} /><i className={row.review} /><i className={row.review} /><i className={row.review} /></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
        ...
        <TextareaAutosize placeholder="Give Feedback Here" className="textcom"/><br/><br/>
